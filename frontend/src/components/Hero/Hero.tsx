  ...
  return (
    <section className="mx-auto flex max-w-5xl flex-col items-center pt-28 text-center">
      ...
      <div className="mb-8 flex items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/10 px-4 py-2">
        <span className="flex justify-center items-center gap-2 text-xs font-medium text-sky-300">
          <Sparkles size={16} />
      ...
      <div className="mt-10 flex flex-col gap-4 sm:flex-row">
        <a href="https://chat2order-frontend.vercel.app/" target="_blank" rel="noopener noreferrer">
          <button className="flex h-10 justify-center items-center gap-2 rounded-full bg-sky-500 px-8 py-4 font-medium text-white transition-all hover:bg-sky-400">
            Acessar produto
            <ArrowRight size={18} />
          </button>
        </a>

        <button className="flex h-10 justify-center items-center gap-2 rounded-full border border-white/10 bg-white/5 px-8 py-4 font-medium text-white transition-all hover:bg-white/10">
          <CirclePlay size={18}/>
          Ver como funciona
        </button>
      </div>
